...
export const rawcolliderset_coVoxelPrimitiveGeometry: (a: number, b: number) => number;
...
export const rawshape_voxels: (a: number, b: number, c: number, d: number) => number;
export const rawshape_voxelsFromPoints: (a: number, b: number, c: number, d: number) => number;
