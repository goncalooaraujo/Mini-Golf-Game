...
export enum RawVoxelPrimitiveGeometry {
  PseudoBall = 0,
  PseudoCube = 1,
}
...
export class RawColliderSet {
  ...
  coVoxelPrimitiveGeometry(handle: number): RawVoxelPrimitiveGeometry | undefined;
...
export class RawShape {
  ...
  static voxels(primitive_geometry: RawVoxelPrimitiveGeometry, voxel_size: RawVector, grid_coords: Int32Array): RawShape;
  static voxelsFromPoints(primitive_geometry: RawVoxelPrimitiveGeometry, voxel_size: RawVector, points: Float32Array): RawShape;
