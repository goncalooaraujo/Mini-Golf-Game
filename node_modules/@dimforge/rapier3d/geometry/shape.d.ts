...
import { RawColliderSet, RawShape, RawVoxelPrimitiveGeometry } from "../raw";
...
export declare class Voxels extends Shape {
     ...
     */
    constructor(data: Float32Array | Int32Array, voxelSize: Vector, primitiveGeometry?: RawVoxelPrimitiveGeometry);
    intoRaw(): RawShape;
}
/**
 * A shape that is a triangle mesh.
